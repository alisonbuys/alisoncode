...
export default function ProjectsPage() {
  return (
    <div className="h-screen bg-purple-100">
      ...
      <div className="container m-1 w-96 mx-auto rounded-lg border-2 border-white bg-purple-200 hover:bg-purple-50 sm:mx-auto sm:w-96 md:mx-auto md:w-96 lg:mx-auto lg:w-1/2">
