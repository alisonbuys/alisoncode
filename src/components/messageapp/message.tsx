...
export function MessageApp() {
  ...
  return (
    <>
      ...
      <main className="flex h-screen w-screen flex-col bg-sky-100 p-8">
        {/* <BackButton /> */}

        <BackButton />

        <div className="mx-auto h-fit w-80 overflow-hidden rounded-2xl border-2 border-black bg-orange-50 shadow-xl">
